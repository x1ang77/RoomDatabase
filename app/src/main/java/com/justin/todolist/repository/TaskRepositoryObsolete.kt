...
//        taskMap[++counter] = task
    ...
    companion object {
        private var taskRepositoryObsolete: TaskRepositoryObsolete? = null
        fun getInstance(): TaskRepositoryObsolete {
            if (taskRepositoryObsolete == null) {
                taskRepositoryObsolete = TaskRepositoryObsolete()
            }

            return taskRepositoryObsolete!!
        }
    }
}
